...
if ARGV[0] == 'get_definition'
	puts "Creates a new C# console application"
	exit
end
...
<Project DefaultTargets=\"Build\" ToolsVersion=\"3.5\" xmlns=\"http://schemas.microsoft.com/developer/msbuild/2003\">
	...
	<Import Project=\"$(MSBuildBinPath)\\Microsoft.fsharp.targets\" />
</Project>"
	content
end
...
main = File.join(File.dirname(filepath), "Program.cs")
File.open(main, "w") { |file|
	file.puts getMainContent(project_name)
}
