...
using fsharp.Processes;

namespace fsharp.Commands
{
	class CreateHandler : ICommandHandler
	{
		private fsharp.Files.IResolveFileTypes _fileTypeResolver;
		...
		public CreateHandler(
			fsharp.Files.IResolveFileTypes fileTypeResolver)
		{
	...
	class CreateTemplate : ICreateTemplate
	{
		...
		private fsharp.Files.IResolveFileTypes _typeResolver;
		
		public fsharp.Files.IFile File { get; private set; }
		public int Line { get; private set; }
		public int Column { get; private set; }
		
		public CreateTemplate(string file, fsharp.Files.IResolveFileTypes typeResolver)
		{
			File = null;
			_file = file;
